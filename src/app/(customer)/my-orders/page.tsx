                    ...
                    orders.length > 0 ? (
                        orders.map((order, i) => (
                            <div className="flex flex-col border-2 w-4/5 mt-6">
                                ...
                                <ul className="max-h-0 px-4 overflow-hidden md:grid md:grid-cols-2 md:grid-rows-2 transition-max-height duration-500 ease-in-out peer-checked:max-h-52 md:peer-checked:max-h-40">
                                    <li className='my-3'><span className='mr-6 font-semibold'>OrderId:</span><span>{order["_id"]}</span></li>
                                    <li className='my-3'><span className='mr-6 font-semibold'>Order Date:</span><span>{order["createAt"]}</span></li>
