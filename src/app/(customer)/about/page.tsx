    ...
    return (
        <div className="flex flex-col justify-center bg-white">
            <div className="container max-w-5xl mx-auto p-4 md:p-6 lg:p-12">
                ...
                <div className="flex flex-wrap justify-center mb-12">
                    <div className="w-full md:w-1/2 lg:w-1/3 mb-4 mr-16">
                        <img src={"/cheff.avif"} width={200} height={200} alt="cheff" className="h-[28vh] rounded-full" />
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/3 mb-4">
                        <img src={"/team.jpg"} width={200} height={200} alt="cheff" className="h-[28vh] rounded-full" />
                ...
                <div className="flex flex-col justify-center">
                    <button onClick={() => navigate.push('/reservation')} className="relative inline-block px-4 w-fit py-2 text-white uppercase text-sm tracking-wider font-medium overflow-hidden transition-all duration-300 group">
