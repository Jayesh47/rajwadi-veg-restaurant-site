        ...
        <section className="mb-9">
            ...
            <div className="party">
                <div className="party-banner flex justify-center">
                    <Image src={"/delicates.jpg"} className="w-[85%] h-[50vh]" width={1000} height={200} alt="party"></Image>
                    <div className="flex w-[85%] h-[50vh] backdrop-brightness-50 absolute m-auto flex-col items-center justify-center">
                        <h2 className="text-white text-[48px] font-[700]">Need Your Best Party</h2>
                        <h2 className="text-[38px] text-rose-300 font-[700] font-serif italic">Events Rooms</h2>
                    </div>
                </div>
            </div>
            <div className="group-dinner flex w-[70%] m-auto my-9">
                <div className="left">
                    <Image src={"/poster-3.jpg"} className="w-[50em] h-[50vh]" width={1000} height={200} alt="Group Dinner"></Image>
                </div>
                <div className="right w-[50em] flex flex-col justify-around mx-9">
            ...
            <div className="group-dinner flex w-[70%] m-auto my-9 flex-row-reverse">
                <div className="left">
                    <Image src={"/delicates.jpg"} className="w-[50em] h-[50vh]" width={1000} height={200} alt="Group Dinner"></Image>
                </div>
                <div className="right w-[50em] flex flex-col items-end justify-around mx-9">
                    <h3 className="font-serif italic text-[25px] text-slate-400">Playing Music</h3>
                    <h3 className="text-[35px]">New Ideas Each Time</h3>
                    <hr />
                    <p className="text-right">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At quasi voluptatem error corrupti accusamus molestiae repellat iste sunt deleniti expedita laudantium in praesentium ad minima, unde, dicta.</p>
                    <button className="btn py-2 px-4 bg-[#c59d5f] text-white w-fit border-[#c59d5f] transition-all ease-in-out border-2 hover:bg-white hover:text-[#c59d5f]">Book Now</button>
                </div>
            </div>
            <div className="group-dinner flex w-[70%] m-auto my-9">
                <div className="left">
                    <Image src={"/poster.jpg"} className="w-[50em] h-[50vh]" width={1000} height={200} alt="Group Dinner"></Image>
                </div>
                <div className="right w-[50em] flex flex-col justify-around mx-9">
